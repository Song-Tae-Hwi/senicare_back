...
import com.project.senicare.handler.OAuth2SuccessHandler;
import com.project.senicare.service.implement.OAuth2UserServiceimplement;
...
class AuthenticationFailEntryPoint implements AuthenticationEntryPoint {
  ...
  public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException)
    ...
    response.getWriter().write("{ \" code \": \"" + ResponseCode.AUTHENTICATION_FAIL + "\", \" message \" : \""
