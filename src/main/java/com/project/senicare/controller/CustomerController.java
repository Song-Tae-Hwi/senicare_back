...
public class CustomerController {
  ...
  public ResponseEntity<? super GetCustomerResponseDto> getCustomer(
    ...
    ResponseEntity<? super GetCustomerResponseDto> reponse = customerService.getCustomer(customerNumber);
    return reponse;
  }
  ...
  public ResponseEntity<ResponseDto> postCareRecord(
    ...
    if ((usedToolNumber != null && count == null) || (usedToolNumber == null && count != null))
