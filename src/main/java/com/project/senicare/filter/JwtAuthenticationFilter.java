package com.project.senicare.filter;
...
// - security context 에 접근제어자 정보 등록
@Component
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  private void setContext(HttpServletRequest request, String userId) {
    ...
    // 접근 주체에 대한 인증 토큰 생성
    AbstractAuthenticationToken autenticationToken = new UsernamePasswordAuthenticationToken(userId, null,
